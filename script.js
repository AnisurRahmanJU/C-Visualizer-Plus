const CoreTraceRepository = {
    ...
    ex19: {
        ...
        steps: [
            { line: 4, bss: "Clean", data: "Empty", console: "Initializing standard register validation index sequence threshold = 500.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF14", var: "threshold", val: "500" }] }], heap: [], vars: [{ name: "threshold", type: "int", scope: "main", val: "500" }],  structures: null },
            { line: 5, bss: "Clean", data: "Empty", console: "Setting mutable accumulator block variable step_check = 0.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF14", var: "threshold", val: "500" }, { addr: "0x7FFF18", var: "step_check", val: "0" }] }], heap: [], vars: [{ name: "step_check", type: "int", scope: "main", val: "0" }], structures: null },
            { line: 6, bss: "Clean", data: "Empty", console: "Initializing dynamic tracking verification loop block state k = 0.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "0" }, { addr: "0x7FFF20", var: "k", val: "0" }] }], heap: [], vars: [{ name: "k", type: "int", scope: "main", val: "0" }],  structures: null },
            { line: 7, bss: "Clean", data: "Empty", console: "Accumulation step verification update matrix cycle pass: step_check = 0 + 0 = 0.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "0" }] }], heap: [], vars: [{ name: "step_check", type: "int", scope: "main", val: "0" }], structures: null },
            { line: 6, bss: "Clean", data: "Empty", console: "Post iteration step verification layout pointer incremented: k = 1. Rule verification check (1 < 10) -> TRUE.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "0" }, { addr: "0x7FFF20", var: "k", val: "1" }] }], heap: [], vars: [{ name: "k", type: "int", scope: "main", val: "1" }],  structures: null },
            { line: 7, bss: "Clean", data: "Empty", console: "Accumulation step verification update matrix cycle pass: step_check = 0 + 2 = 2.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "2" }] }], heap: [], vars: [{ name: "step_check", type: "int", scope: "main", val: "2" }], structures: null },
            { line: 6, bss: "Clean", data: "Empty", console: "Post iteration step verification layout pointer incremented: k = 2. Rule verification check (2 < 10) -> TRUE.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "2" }, { addr: "0x7FFF20", var: "k", val: "2" }] }], heap: [], vars: [{ name: "k", type: "int", scope: "main", val: "2" }], structures: null },
            { line: 7, bss: "Clean", data: "Empty", console: "Accumulation step verification update matrix cycle pass: step_check = 2 + 4 = 6.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "6" }] }], heap: [], vars: [{ name: "step_check", type: "int", scope: "main", val: "6" }],  structures: null },
            { line: 6, bss: "Clean", data: "Empty", console: "Post iteration step verification layout pointer incremented: k = 3. Rule verification check (3 < 10) -> TRUE.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "6" }, { addr: "0x7FFF20", var: "k", val: "3" }] }], heap: [], vars: [{ name: "k", type: "int", scope: "main", val: "3" }], structures: null },
            { line: 7, bss: "Clean", data: "Empty", console: "Accumulation step verification update matrix cycle pass: step_check = 6 + 6 = 12.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "12" }] }], heap: [], vars: [{ name: "step_check", type: "int", scope: "main", val: "12" }], structures: null },
            { line: 6, bss: "Clean", data: "Empty", console: "Post iteration step verification layout pointer incremented: k = 4. Rule verification check (4 < 10) -> TRUE.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "12" }, { addr: "0x7FFF20", var: "k", val: "4" }] }], heap: [], vars: [{ name: "k", type: "int", scope: "main", val: "4" }], structures: null },
            { line: 7, bss: "Clean", data: "Empty", console: "Accumulation step verification update matrix cycle pass: step_check = 12 + 8 = 20.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "20" }] }], heap: [], vars: [{ name: "step_check", type: "int", scope: "main", val: "20" }],   structures: null },
            { line: 6, bss: "Clean", data: "Empty", console: "Post iteration step verification layout pointer incremented: k = 5. Rule verification check (5 < 10) -> TRUE.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "20" }, { addr: "0x7FFF20", var: "k", val: "5" }] }], heap: [], vars: [{ name: "k", type: "int", scope: "main", val: "5" }], structures: null },
            { line: 7, bss: "Clean", data: "Empty", console: "Accumulation step verification update matrix cycle pass: step_check = 20 + 10 = 30.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "30" }] }], heap: [], vars: [{ name: "step_check", type: "int", scope: "main", val: "30" }], structures: null },
            { line: 6, bss: "Clean", data: "Empty", console: "Post iteration step verification layout pointer incremented: k = 6. Rule verification check (6 < 10) -> TRUE.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "30" }, { addr: "0x7FFF20", var: "k", val: "6" }] }], heap: [], vars: [{ name: "k", type: "int", scope: "main", val: "6" }], structures: null },
            { line: 7, bss: "Clean", data: "Empty", console: "Accumulation step verification update matrix cycle pass: step_check = 30 + 12 = 42.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "42" }] }], heap: [], vars: [{ name: "step_check", type: "int", scope: "main", val: "42" }], structures: null },
            { line: 6, bss: "Clean", data: "Empty", console: "Post iteration step verification layout pointer incremented: k = 7. Rule verification check (7 < 10) -> TRUE.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "42" }, { addr: "0x7FFF20", var: "k", val: "7" }] }], heap: [], vars: [{ name: "k", type: "int", scope: "main", val: "7" }], structures: null },
            { line: 7, bss: "Clean", data: "Empty", console: "Accumulation step verification update matrix cycle pass: step_check = 42 + 14 = 56.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "56" }] }], heap: [], vars: [{ name: "step_check", type: "int", scope: "main", val: "56" }], structures: null },
            { line: 6, bss: "Clean", data: "Empty", console: "Post iteration step verification layout pointer incremented: k = 8. Rule verification check (8 < 10) -> TRUE.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "56" }, { addr: "0x7FFF20", var: "k", val: "8" }] }], heap: [], vars: [{ name: "k", type: "int", scope: "main", val: "8" }], structures: null },
            { line: 7, bss: "Clean", data: "Empty", console: "Accumulation step verification update matrix cycle pass: step_check = 56 + 16 = 72.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "72" }] }], heap: [], vars: [{ name: "step_check", type: "int", scope: "main", val: "72" }], structures: null },
            { line: 6, bss: "Clean", data: "Empty", console: "Post iteration step verification layout pointer incremented: k = 9. Rule verification check (9 < 10) -> TRUE.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "72" }, { addr: "0x7FFF20", var: "k", val: "9" }] }], heap: [], vars: [{ name: "k", type: "int", scope: "main", val: "9" }], structures: null },
            { line: 7, bss: "Clean", data: "Empty", console: "Accumulation step verification update matrix cycle pass: step_check = 72 + 18 = 90.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "90" }] }], heap: [], vars: [{ name: "step_check", type: "int", scope: "main", val: "90" }], structures: null },
            { line: 6, bss: "Clean", data: "Empty", console: "Post iteration step verification layout pointer incremented: k = 10. Rule verification check (10 < 10) -> FALSE. Terminating context matrix.", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "90" }] }], heap: [], vars: [{ name: "k", type: "int", scope: "main", val: "10" }], structures: null },
            { line: 9, bss: "Clean", data: "Empty", console: "Output: Final Step Check Register: 90", stack: [{ name: "main()", addr: "0x7FFF10", locals: [{ addr: "0x7FFF18", var: "step_check", val: "90" }] }], heap: [], vars: [], structures: null }
        ]
    },
    ex20: {
...
let compilationBaseHTML = ""; // কম্পিলেশনের শুরুর আউটপুট ট্র্যাক রাখার জন্য ভেরিয়েবল
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (btnPrev) btnPrev.addEventListener("click", executePrevTraceStep);
    if (btnNext) btnNext.addEventListener("click", executeNextTraceStep);
...
function triggerCompilationSequence() {
    ...
    setTimeout(() => {
        ...
        let successMsg = `<div>⚙️ <span style="color:#a142f4">Parsing C Abstract Syntax Tree (AST) segments...</span></div><div style="color:#0f9d58">✔️ Translation Unit linked. Code steps parsed successfully. Use 'Next' button to walk execution.</div>`;
        consoleBox.innerHTML = successMsg;
        compilationBaseHTML = successMsg; // বেস আউটপুট সেভ করে রাখা হলো
...
function executeNextTraceStep() {
    // যদি আমরা ইতিমধ্যেই শেষ স্টেপে থাকি এবং Terminated মেসেজ দেখানোর জন্য বাটন ক্লিক হয়
    if (currentTraceIndex === activeStepsList.length - 1) {
        currentTraceIndex++;
        const consoleBox = document.getElementById("terminal");
        if (consoleBox) {
            consoleBox.innerHTML += `<div class="sys-ln-terminated"><br><span style="color:#ea4335">Process terminated. Frame resources unlinked.</span></div>`;
            consoleBox.scrollTop = consoleBox.scrollHeight;
        }
    ...
    if (currentTraceIndex > 0 && btnPrev) {
        btnPrev.disabled = false;
    }

    applyTraceStepVisuals(currentTraceIndex, true);
}

function executePrevTraceStep() {
    if (currentTraceIndex <= 0) return;
    ...
    // যদি টার্মিনেটেড স্টেট থেকে ব্যাক করা হয়, স্ট্যাটাস আবার একটিভ হবে
    if (statusBadge && (statusBadge.innerText === "Terminated" || statusBadge.className.includes("terminated"))) {
        statusBadge.innerText = "Active";
        statusBadge.className = "status-badge active";
    }
    ...
    // আউটপুট উইন্ডো রি-বিল্ড করা (যাতে Terminated মেসেজ বা ফরোয়ার্ড লাইনের মেসেজ ক্লিন হয়ে যায়)
    rebuildConsoleOutputLog();

    // UI ভিজ্যুয়াল এক ধাপ ব্যাকস্টেটে সিঙ্ক করা (কনসোলে কোনো নতুন লেখা যোগ হবে না)
    applyTraceStepVisuals(currentTraceIndex, false);
}

// টার্মিনালের লগকে বর্তমান ইণ্ডেক্স অনুযায়ী রি-রেন্ডার করার ফাংশন (মুছে ফেলার কাজ করে)
function rebuildConsoleOutputLog() {
    const consoleBox = document.getElementById("terminal");
...
function applyTraceStepVisuals(index, isForward) {
    ...
    clearCodeLineHighlights();
    if (codeMirrorEditor && currentStepPayload) {
